...
from stable_baselines3.ppo import MlpPolicy as PPOnn
from stable_baselines3.dqn import MlpPolicy as DQNnn
from stable_baselines3.a2c import MlpPolicy as A2Cnn
from stable_baselines3.td3 import MlpPolicy as TD3nn
from stable_baselines3.ddpg import MlpPolicy as DDPGnn
from stable_baselines3.sac import MlpPolicy as SACnn
from tgm.agents.AgentInterface import AgentInterface
from tgm.agents.callbacks.StableBaselineCallback import StableBaselineCallback
from tgm.agents.save.Checkpoint import Checkpoint
from tgm.environments.wrappers.NumpyWrapper import NumpyWrapper
import logging
import torch
...
class StableBaselineAgent(AgentInterface):
    ...
    def __init__(
        self, agent_name, tensorboard_dir, checkpoint_dir, total_rewards=0, steps_done=0, use_rms_prop=False,
        hp_tuner=None, name=None, trainable=True, image_shape=None, **agent_kwargs
    ):
        """
        ...
        :param image_shape: the size of the input image
        :param trainable: whether the agent can be trained
        :param use_rms_prop: True if rms_prop needs to be used, False otherwise
        """
        ...
        if agent_name == "dqn" and use_rms_prop is True:
            self.agent_kwargs["policy_kwargs"] = {"optimizer_class": RMSpropTFLike}
    ...
    def train(self, env, config):
        ...
        # Provide the environment to the agent.
        self.env = env
