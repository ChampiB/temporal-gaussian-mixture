...
class Shell(ctk.CTkFrame):
    ...
    def compute(self, cmd):
        ...
        variables = {
            "x0": self.debugger.checkpoints[self.prev_gm]["gm_data"].get(),
            "W0": self.debugger.checkpoints[self.prev_gm]["gm"].W,
            "m0": self.debugger.checkpoints[self.prev_gm]["gm"].m,
            "v0": self.debugger.checkpoints[self.prev_gm]["gm"].v,
            "beta0": self.debugger.checkpoints[self.prev_gm]["gm"].β,
            "d0": self.debugger.checkpoints[self.prev_gm]["gm"].d,
            "W0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].W_bar,
            "m0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].m_bar,
            "v0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].v_bar,
            "beta0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].β_bar,
            "d0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].d_bar,
            "x0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].x_bar,
            "r0_bar": self.debugger.checkpoints[self.prev_gm]["gm"].r_bar,
            "W0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].W_hat,
            "m0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].m_hat,
            "v0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].v_hat,
            "beta0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].β_hat,
            "d0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].d_hat,
            "r0_hat": self.debugger.checkpoints[self.prev_gm]["gm"].r_hat,
            "N0_prime": self.debugger.checkpoints[self.prev_gm]["gm"].N_prime,
            "x0_prime": self.debugger.checkpoints[self.prev_gm]["gm"].x_prime,
            "S0_prime": self.debugger.checkpoints[self.prev_gm]["gm"].S_prime,
            "N0_second": self.debugger.checkpoints[self.prev_gm]["gm"].N_second,
            ...
            "beta1": self.debugger.checkpoints[self.next_gm]["gm"].β,
            "d1": self.debugger.checkpoints[self.next_gm]["gm"].d,
            "W1_bar": self.debugger.checkpoints[self.next_gm]["gm"].W_bar,
            "m1_bar": self.debugger.checkpoints[self.next_gm]["gm"].m_bar,
            "v1_bar": self.debugger.checkpoints[self.next_gm]["gm"].v_bar,
            "beta1_bar": self.debugger.checkpoints[self.next_gm]["gm"].β_bar,
            "d1_bar": self.debugger.checkpoints[self.next_gm]["gm"].d_bar,
            "x1_bar": self.debugger.checkpoints[self.next_gm]["gm"].x_bar,
            "r1_bar": self.debugger.checkpoints[self.next_gm]["gm"].r_bar,
            "W1_hat": self.debugger.checkpoints[self.next_gm]["gm"].W_hat,
            "m1_hat": self.debugger.checkpoints[self.next_gm]["gm"].m_hat,
            "v1_hat": self.debugger.checkpoints[self.next_gm]["gm"].v_hat,
            "beta1_hat": self.debugger.checkpoints[self.next_gm]["gm"].β_hat,
            "d1_hat": self.debugger.checkpoints[self.next_gm]["gm"].d_hat,
            "r1_hat": self.debugger.checkpoints[self.next_gm]["gm"].r_hat,
            "N1_prime": self.debugger.checkpoints[self.next_gm]["gm"].N_prime,
            "x1_prime": self.debugger.checkpoints[self.next_gm]["gm"].x_prime,
            "S1_prime": self.debugger.checkpoints[self.next_gm]["gm"].S_prime,
            "N1_second": self.debugger.checkpoints[self.next_gm]["gm"].N_second,
            "x1_second": self.debugger.checkpoints[self.next_gm]["gm"].x_second,
            "S1_second": self.debugger.checkpoints[self.next_gm]["gm"].S_second,
            "gm1": self.debugger.checkpoints[self.next_gm]["gm"]
        }
        functions = {
            "near": self.near
        }
